...
As one can see, in this way we created a object of class Particle,
...
must be indented deeper than ``x'' and should be aligned.
I guess I do not need to explain ``v'' and ``m''

One thing I do not quite see yet (need to ask Nakamura-san?) is how to
convert a file with multiple objects to multiple ruby objects, but
...
We call this format with basic naming convension PSDS (Particle Stream
Data Format).
